...
if(isset($_SESSION["username"])){
    ...
    $sql_send_notification_to_passenger = "INSERT INTO remora_db.notifications(notification_id, receiver, issuer, travel_id, type, notification_date, wallet) VALUES ('$notification_id_hash', '$var_new_receiver', '$username_session_issuer', '$var_travel_id', 'INFORMATION_REFUSED', '$effective_notification_time', '');";
