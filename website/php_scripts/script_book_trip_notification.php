            ...
            if($row["available_spots"] > 0){
                if($notification_user !== $effective_driver){
                    ...
                    if ($result->num_rows == 0) {
                        ...
                        $sql_insert_notification = "INSERT INTO remora_db.notifications (notification_id, receiver, issuer, travel_id, type, notification_date) VALUES ('$notification_id', '$effective_driver', '$notification_user', '$travel_id', 'CONFIRMATION', '$effective_notification_time');";
                        ...
                        $response = array('message' => 'BOOK Successful: wait some time for the driver confirmation');
