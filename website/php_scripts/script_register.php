...
$sql = "INSERT INTO remora_db.users (username, email, name, surname, balance, travel_stats, trips_given, trips_received, minted_gears, password) VALUES ('$username_id', '$email_id', '$name_id', '$surname_id', '0', '0', '0', '0', '0', '$password_id');";
