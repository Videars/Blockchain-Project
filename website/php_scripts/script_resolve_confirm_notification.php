...
if(isset($_SESSION["username"])){
    ...
    $sql_send_notification_to_passenger = "INSERT INTO remora_db.notifications(notification_id, receiver, issuer, travel_id, type, notification_date) VALUES ('$notification_id_hash', '$var_new_receiver', '$username_session_issuer', '$var_travel_id', 'INFORMATION_ACCEPTED', '$effective_notification_time');";
    ...
    if($result_driver_check->num_rows == 0){
        $sql_driver_update_ongoing_trips_table = "INSERT INTO remora_db.ongoing_trips(travel_id, username, role) VALUES ('$var_travel_id', '$username_session_issuer', 'DRIVER')";
        
        $conn->query($sql_driver_update_ongoing_trips_table);
    }

    $sql_passenger_update_ongoing_trips_table = "INSERT INTO remora_db.ongoing_trips(travel_id, username, role) VALUES ('$var_travel_id', '$var_new_receiver', 'PASSENGER')";
